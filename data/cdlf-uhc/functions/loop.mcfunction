...
execute as @e[tag=Timer,scores={SegundosTotales=..3120}] run bossbar set timer1 name [{"text":"FASE 3 - ","color":"white","bold":true},{"score":{"name":"@s","objective":"Minutos"},"color":"yellow","italic":false},{"text":":","color":"white","italic":false},{"score":{"name":"@s","objective":"Segundos"},"color":"yellow","italic":false}]
execute as @e[tag=Timer,scores={SegundosTotales=..2760}] run bossbar set timer1 name [{"text":"FASE 4 - ","color":"white","bold":true},{"score":{"name":"@s","objective":"Minutos"},"color":"yellow","italic":false},{"text":":","color":"white","italic":false},{"score":{"name":"@s","objective":"Segundos"},"color":"yellow","italic":false}]
